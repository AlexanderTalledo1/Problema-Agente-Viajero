...
namespace ProblemaAgenteViajero
{
    ...
    public class ListaGrafos
    {
        ...
        //public string Select_grafo_nom(int x1, int y1, int z)
        //{
        ...
        //    return List_grafos.ElementAt(z).Departamento;
        //}
        public void Generar_camino(Graphics graphics)
        {
            ...
            camino.AddLine(List_grafos.ElementAt(18).PosicionX, List_grafos.ElementAt(18).PosicionY,
               List_grafos.ElementAt(19).PosicionX, List_grafos.ElementAt(19).PosicionY);
            graphics.DrawPath(Pen, camino);
            camino.AddLine(List_grafos.ElementAt(16).PosicionX, List_grafos.ElementAt(16).PosicionY,
               List_grafos.ElementAt(15).PosicionX, List_grafos.ElementAt(15).PosicionY);
            graphics.DrawPath(Pen, camino);
            camino.AddLine(List_grafos.ElementAt(6).PosicionX, List_grafos.ElementAt(6).PosicionY,
               List_grafos.ElementAt(15).PosicionX, List_grafos.ElementAt(15).PosicionY);
            graphics.DrawPath(Pen, camino);
            camino.AddLine(List_grafos.ElementAt(19).PosicionX, List_grafos.ElementAt(19).PosicionY,
                List_grafos.ElementAt(20).PosicionX, List_grafos.ElementAt(20).PosicionY);
            graphics.DrawPath(Pen, camino);
            camino.AddLine(List_grafos.ElementAt(20).PosicionX, List_grafos.ElementAt(20).PosicionY,
               List_grafos.ElementAt(17).PosicionX, List_grafos.ElementAt(17).PosicionY);
            graphics.DrawPath(Pen, camino);
            camino.AddLine(List_grafos.ElementAt(20).PosicionX, List_grafos.ElementAt(20).PosicionY,
            ...
            camino.AddLine(List_grafos.ElementAt(5).PosicionX, List_grafos.ElementAt(5).PosicionY,
               List_grafos.ElementAt(14).PosicionX, List_grafos.ElementAt(14).PosicionY);
            graphics.DrawPath(Pen, camino);
            camino.AddLine(List_grafos.ElementAt(13).PosicionX, List_grafos.ElementAt(13).PosicionY,
               List_grafos.ElementAt(12).PosicionX, List_grafos.ElementAt(12).PosicionY);
            graphics.DrawPath(Pen, camino);
            camino.AddLine(List_grafos.ElementAt(12).PosicionX, List_grafos.ElementAt(12).PosicionY,
               List_grafos.ElementAt(11).PosicionX, List_grafos.ElementAt(11).PosicionY);
            graphics.DrawPath(Pen, camino);
            camino.AddLine(List_grafos.ElementAt(11).PosicionX, List_grafos.ElementAt(11).PosicionY,
               List_grafos.ElementAt(21).PosicionX, List_grafos.ElementAt(21).PosicionY);
            graphics.DrawPath(Pen, camino);
            camino.AddLine(List_grafos.ElementAt(4).PosicionX, List_grafos.ElementAt(4).PosicionY,
               List_grafos.ElementAt(21).PosicionX, List_grafos.ElementAt(21).PosicionY);
            graphics.DrawPath(Pen, camino);
            camino.AddLine(List_grafos.ElementAt(10).PosicionX, List_grafos.ElementAt(10).PosicionY,
               List_grafos.ElementAt(0).PosicionX, List_grafos.ElementAt(0).PosicionY);
            graphics.DrawPath(Pen, camino);
            camino.AddLine(List_grafos.ElementAt(22).PosicionX, List_grafos.ElementAt(22).PosicionY,
               List_grafos.ElementAt(10).PosicionX, List_grafos.ElementAt(10).PosicionY);
            graphics.DrawPath(Pen, camino);
            camino.AddLine(List_grafos.ElementAt(22).PosicionX, List_grafos.ElementAt(22).PosicionY,
             List_grafos.ElementAt(23).PosicionX, List_grafos.ElementAt(23).PosicionY);
            graphics.DrawPath(Pen, camino);
            camino.AddLine(List_grafos.ElementAt(23).PosicionX, List_grafos.ElementAt(23).PosicionY,
             List_grafos.ElementAt(20).PosicionX, List_grafos.ElementAt(20).PosicionY);
            graphics.DrawPath(Pen, camino);
            camino.AddLine(List_grafos.ElementAt(23).PosicionX, List_grafos.ElementAt(23).PosicionY,
           List_grafos.ElementAt(21).PosicionX, List_grafos.ElementAt(21).PosicionY);
